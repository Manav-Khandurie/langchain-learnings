...
def create_chat_prompt():
    """Create and return a ChatPromptTemplate with system and user messages.
    
    Returns:
        ChatPromptTemplate: Configured prompt template for the chat assistant
    """
...
def initialize_llm_chain():
    ...
    Returns:
        Chain: Configured processing chain (prompt -> LLM -> output parser)
    """
...
# Process user input and display results if input exists
if input_text:
